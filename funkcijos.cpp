...
for(auto &i: vargsas)
{
         ...
         bad<<left;
         bad<<setw(14)<<i.getvardas()<<setw(28)<<i.getpavarde();
         bad<<std::fixed<<std::setprecision(2)<<setw(5)<<i.getvidurkis()<<" "<<std::setprecision(2)<<i.getmediana()<<endl;
}
bad.close();
}
if(saunuolis.size()>0)
...
for(auto &j: saunuolis)
{
         ...
         good<<left;
         good<<setw(14)<<j.getvardas()<<setw(28)<<j.getpavarde();
         good<<std::fixed<<std::setprecision(2)<<setw(5)<<j.getvidurkis()<<" "<<std::setprecision(2)<<j.getmediana()<<endl;
}
good.close();
}
